class TestcategoriesController < ApplicationController
  ...
  private
    ...
    def testcategory_params
      params.require(:testcategory).permit(:testcategoryname, :testname ,tests_attributes: [:id, :testname, :_destroy,   :qname ,questions_attributes: [:id, :qname, :_destroy, :aname ,answers_attributes: [:id, :aname, :ansname, :_destroy]] ])
    end
end
